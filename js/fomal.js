...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://cdn.jsdelivr.net/npm/ashenwitch/girl.jpeg);
    --darkmode-bg:url(https://cdn.jsdelivr.net/npm/ashenwitch/girl.jpeg);
    --mobileday-bg: url(https://cdn.jsdelivr.net/npm/ashenwitch/girl.jpeg);
    --mobilenight-bg: url(https://cdn.jsdelivr.net/npm/ashenwitch/girl.jpeg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
